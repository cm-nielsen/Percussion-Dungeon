...
namespace UnityEditor
{
    ...
    public class RuleTileEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            tile.extendAllTiles = EditorGUILayout.Toggle("Extend All Tiles", tile.extendAllTiles);
            tile.ignoreSelf = EditorGUILayout.Toggle("Ignore Self", tile.ignoreSelf);
            tile.sibling = EditorGUILayout.ObjectField("Sibling", tile.sibling, typeof(RuleTile), false) as RuleTile;
