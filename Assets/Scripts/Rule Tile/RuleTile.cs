...
namespace UnityEngine
{
    ...
    {
        /// <summary>
        /// Makes the rule tiles build off all tiles rather than just itself
        /// </summary>
        public bool extendAllTiles;

        public bool ignoreSelf;

        public RuleTile sibling;
        ...
        public virtual bool RuleMatch(int neighbor, TileBase other)
        {
            ...
            switch (neighbor)
            {
                case TilingRule.Neighbor.This:
                    if (ignoreSelf && other == this)
                        return false;
                    if (extendAllTiles)
                        return other;
                    else if(sibling)
                        return other == this || other == sibling;
                    else
                        return other == this;
